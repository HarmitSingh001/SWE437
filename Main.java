...
public class Main {
	...
	public static void main(String args[]) {
		...
		System.out.println("Qoute's Keyword: " + quote.getKeyword());
		startupMenu();
		...
		while (cont) {
			...
			if (input.equals("Q") || input.equals("q")) { // generate random quote
				...
				System.out.println("Qoute's Keyword: " + randomquote.getKeyword());
				...
				Quote keywordquote = quotelist.search(keyword, 3).getQuote(0);
				System.out.println(keywordquote.getQuoteText());
				System.out.println("This is the Quotes Keyword: " + keyword);
